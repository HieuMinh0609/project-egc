...
const chart = lightningChart()
    ...
    .setTitle(`Bảng điều khiển (${CHANNELS_AMOUNT} chs, ${DATA_FREQUENCY_HZ} Hz)`)
const axisX = chart
    .getDefaultAxisX()
    .disableAnimations()
    .setScrollStrategy(AxisScrollStrategies.progressive)
    .setInterval(-xIntervalMax, 0)
    .setTitle('Dữ liệu điện tâm đồ')
